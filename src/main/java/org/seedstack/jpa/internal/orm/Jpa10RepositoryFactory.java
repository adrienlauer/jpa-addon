...
public class Jpa10RepositoryFactory extends BaseJpaRepositoryFactory {
  ...
  doCreateRepository(Class<AggregateRootT> aggregateRootClass, Class<IdT> identifierClass) {
   ...
   */
  public static class Jpa10Repository<AggregateRootT extends AggregateRoot<IdT>, IdT> extends
    ...
    protected Jpa10Repository(Class<AggregateRootT> aggregateRootClass, Class<IdT> idClass) {
    ...
    public Stream<AggregateRootT> get(Specification<AggregateRootT> specification,
      ...
      if (specification instanceof TrueSpecification) {
        ...
        AggregateRootT found = entityManager.find(getAggregateRootClass(),
