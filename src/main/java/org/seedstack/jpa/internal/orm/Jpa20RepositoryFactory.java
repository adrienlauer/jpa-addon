...
public class Jpa20RepositoryFactory extends BaseJpaRepositoryFactory {
  ...
  @Override
  public <A extends AggregateRoot<ID>, ID> Repository<A, ID> doCreateRepository(
      Class<A> aggregateRootClass, Class<ID> identifierClass) {
    return new Jpa20Repository<>(aggregateRootClass, identifierClass);
  }

  /**
   * <p>
   * Extending {@link Jpa10RepositoryFactory.Jpa10Repository}, this implementation of business
   * framework repository
   * takes advantage of JPA 2.0 features. Specifications are fully supported on
   * {@link #get(Specification, Option...)}
   * and {@link #count(Specification)} methods.
   * </p>
   *
   * <p>
   * Only {@link TrueSpecification}, {@link FalseSpecification} and {@link IdentitySpecification}
   ...
   */
  public static class Jpa20Repository<A extends AggregateRoot<ID>, ID> extends
      Jpa10RepositoryFactory.Jpa10Repository<A, ID> {
